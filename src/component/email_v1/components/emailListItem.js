...
class EmailListItem extends React.Component {
    ...
    render() {
        return (
            ...
            <div className="pm"><div className="lable" style={{ backgroundColor: this.props.state }} >
                </div>
                {this.props.showCheckBox ?
                    (
                        <input type="checkbox" style={{ width: '15px', height: '15px' ,marginTop:"1rem"}} checked={this.isChecked()} />
                    ) : null
                }
