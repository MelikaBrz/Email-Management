            ...
            case PAGE_STATES.GET_ACCOUNT_INF:
                switch (this.state.account_type) {
                    ...
                    case ACCOUNTS_TYPE.YAHOO:
                        return <Yahoo onAddNewAccount={(account_inf) => {this.props.onAddNewAccount({...account_inf,type:'Yahoo'})}} />
                    case ACCOUNTS_TYPE.OFFICE:
                    return <Office onAddNewAccount={(account_inf) => {this.props.onAddNewAccount({...account_inf,type:'Office'})}} />
                    case ACCOUNTS_TYPE.HOTMAIL:
                    return  <Hotmail onAddNewAccount={(account_inf) => {this.props.onAddNewAccount({...account_inf,type:'Hotmail'})}} />
                        case ACCOUNTS_TYPE.OTHER:   
                        return <Other onAddNewAccount={(account_inf) => {this.props.onAddNewAccount({...account_inf,type:'Other'})}} />
                    default:
                        break;
                }
